...
// Displays all roles information
const showAllRoles = () => {
...
// Asks for initial information, then creates entry in database
const addDepartment = () => {
    inquirer.prompt(
        {
            type: 'input',
...
// Asks for initial information for new role, then creates an entry in database
const addRole = () => {
    inquirer.prompt([
        {
            type: 'input',
...
// Asks for initial information of a new employee, then creates an entry in database
const addEmployee = () => {
    inquirer.prompt([
        {
            type: 'input',
...
// Asks which employee user wishes to update, then which fields to update, then prompts for new values of selected fields
